...
class SplashRepo {
  ...
  bool isSplashSeen() {
    return sharedPreferences.getBool(AppConstants.isSplashScreen) != null
        ? sharedPreferences.getBool(AppConstants.isSplashScreen)!
        : false;
  }

  Future<bool> setSplashSeen(bool isSplashSeen) async {
    return await sharedPreferences.setBool(
        AppConstants.isSplashScreen, isSplashSeen);
  }
